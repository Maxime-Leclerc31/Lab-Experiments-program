...
V6tp1e_0 = temps_ligne(X1_0/v + 6 * 1/f)
V6tp1s_0 = temps_ligne(X1_0/v + 7 * 1/f)

V6tp2e_0 = temps_ligne(X2_0/v + 6 * 1/f)
V6tp2s_0 = temps_ligne(X2_0/v + 7 * 1/f)

V6tp3e_0 = temps_ligne(X3_0/v + 6 * 1/f)
V6tp3s_0 = temps_ligne(X3_0/v + 7 * 1/f)

V6tp4e_0 = temps_ligne(X4_0/v + 6 * 1/f)
V6tp4s_0 = temps_ligne(X4_0/v + 7 * 1/f)


V6tp1e_1 = temps_ligne(X1_1/v + 6 * 1/f)
V6tp1s_1 = temps_ligne(X1_1/v + 7 * 1/f)

V6tp2e_1 = temps_ligne(X2_1/v + 6 * 1/f)
V6tp2s_1 = temps_ligne(X2_1/v + 7 * 1/f)

V6tp3e_1 = temps_ligne(X3_1/v + 6 * 1/f)
V6tp3s_1 = temps_ligne(X3_1/v + 7 * 1/f)

V6tp4e_1 = temps_ligne(X4_1/v + 6 * 1/f)
V6tp4s_1 = temps_ligne(X4_1/v + 7 * 1/f)


V6tp1e_2 = temps_ligne(X1_2/v + 6 * 1/f)
V6tp1s_2 = temps_ligne(X1_2/v + 7 * 1/f)

V6tp2e_2 = temps_ligne(X2_2/v + 6 * 1/f)
V6tp2s_2 = temps_ligne(X2_2/v + 7 * 1/f)

V6tp3e_2 = temps_ligne(X3_2/v + 6 * 1/f)
V6tp3s_2 = temps_ligne(X3_2/v + 7 * 1/f)

V6tp4e_2 = temps_ligne(X4_2/v + 6 * 1/f)
V6tp4s_2 = temps_ligne(X4_2/v + 7 * 1/f)
...
# Reading the csv
df_0 = pd.read_csv(f05_A03_x10086_run1, header=None)
df_1 = pd.read_csv(f05_A03_x10186_run1, header=None)
...
df_0.to_csv(r"C:\Maxime\ECM\Stages\SSE\Recherche\19032025\x10086\f05\f05_A03_x10086_run1_modified.csv", index=False)
df_1.to_csv(r"C:\Maxime\ECM\Stages\SSE\Recherche\19032025\x10186\f05\f05_A03_x10186_run1_modified.csv", index=False)
df_2.to_csv(r"C:\Maxime\ECM\Stages\SSE\Recherche\19032025\x10286\f05\f05_A03_x10286_run1_modified.csv", index=False)


# Getting the new file name
f05_A03_x10086_run1_modified = r"C:\Maxime\ECM\Stages\SSE\Recherche\19032025\x10086\f05\f05_A03_x10086_run1_modified.csv"
f05_A03_x10186_run1_modified = r"C:\Maxime\ECM\Stages\SSE\Recherche\19032025\x10186\f05\f05_A03_x10186_run1_modified.csv"
f05_A03_x10286_run1_modified = r"C:\Maxime\ECM\Stages\SSE\Recherche\19032025\x10286\f05\f05_A03_x10286_run1_modified.csv"


# Getting wave x for each probe
df1_0 = pd.read_csv(f05_A03_x10086_run1_modified, skiprows=V6tp1e_0, nrows=V6tp1s_0-V6tp1e_0)
P1_0 = df1_0.iloc[:, C1].tolist()

df2_0 = pd.read_csv(f05_A03_x10086_run1_modified, skiprows=V6tp2e_0, nrows=V6tp2s_0-V6tp2e_0)
P2_0 = df2_0.iloc[:, C2].tolist()

df3_0 = pd.read_csv(f05_A03_x10086_run1_modified, skiprows=V6tp3e_0, nrows=V6tp3s_0-V6tp3e_0)
P3_0 = df3_0.iloc[:, C3].tolist()

df4_0 = pd.read_csv(f05_A03_x10086_run1_modified, skiprows=V6tp4e_0, nrows=V6tp4s_0-V6tp4e_0)
P4_0 = df4_0.iloc[:, C4].tolist()


df1_1 = pd.read_csv(f05_A03_x10186_run1_modified, skiprows=V6tp1e_1, nrows=V6tp1s_1-V6tp1e_1)
P1_1 = df1_1.iloc[:, C1].tolist()

df2_1 = pd.read_csv(f05_A03_x10186_run1_modified, skiprows=V6tp2e_1, nrows=V6tp2s_1-V6tp2e_1)
P2_1 = df2_1.iloc[:, C2].tolist()

df3_1 = pd.read_csv(f05_A03_x10186_run1_modified, skiprows=V6tp3e_1, nrows=V6tp3s_1-V6tp3e_1)
P3_1 = df3_1.iloc[:, C3].tolist()

df4_1 = pd.read_csv(f05_A03_x10186_run1_modified, skiprows=V6tp4e_1, nrows=V6tp4s_1-V6tp4e_1)
P4_1 = df4_1.iloc[:, C4].tolist()


df1_2 = pd.read_csv(f05_A03_x10286_run1_modified, skiprows=V6tp1e_2, nrows=V6tp1s_2-V6tp1e_2)
P1_2 = df1_2.iloc[:, C1].tolist()

df2_2 = pd.read_csv(f05_A03_x10286_run1_modified, skiprows=V6tp2e_2, nrows=V6tp2s_2-V6tp2e_2)
P2_2 = df2_2.iloc[:, C2].tolist()

df3_2 = pd.read_csv(f05_A03_x10286_run1_modified, skiprows=V6tp3e_2, nrows=V6tp3s_2-V6tp3e_2)
P3_2 = df3_2.iloc[:, C3].tolist()

df4_2 = pd.read_csv(f05_A03_x10286_run1_modified, skiprows=V6tp4e_2, nrows=V6tp4s_2-V6tp4e_2)
...
plt.title("Wave 6 at different postions")
plt.xlabel("x")
plt.ylabel("y")
plt.show()
