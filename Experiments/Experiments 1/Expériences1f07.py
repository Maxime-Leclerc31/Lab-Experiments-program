...
V9tp1e_f07 = temps_ligne(X1/v + 9 * 1/f)
V9tp1s_f07 = temps_ligne(X1/v + 10 * 1/f)

V9tp2e_f07 = temps_ligne(X2/v + 9 * 1/f)
V9tp2s_f07 = temps_ligne(X2/v + 10 * 1/f)

V9tp3e_f07 = temps_ligne(X3/v + 9 * 1/f)
V9tp3s_f07 = temps_ligne(X3/v + 10 * 1/f)

V9tp4e_f07 = temps_ligne(X4/v + 9 * 1/f)
V9tp4s_f07 = temps_ligne(X4/v + 10 * 1/f)



# Getting the files names
f07_A03_beach_run1 = r"C:\Maxime\ECM\Stages\SSE\Recherche\17032025\beach\f07\f07_A03_beach_run1.csv"
f07_A03_run1 = r"C:\Maxime\ECM\Stages\SSE\Recherche\17032025\No_beach\f07\f07_A03_run2.csv"


## Getting the csv to a good format for reading values
# Reading the csv
df_b = pd.read_csv(f07_A03_beach_run1, header=None)
df_nb = pd.read_csv(f07_A03_run1, header=None)
...
df_b.to_csv(r"C:\Maxime\ECM\Stages\SSE\Recherche\17032025\beach\f07\f07_A03_beach_run1_modified.csv", index=False)
df_nb.to_csv(r"C:\Maxime\ECM\Stages\SSE\Recherche\17032025\No_beach\f07\f07_A03_run2_modified.csv", index=False)


# Getting the new file name
f07_A03_beach_run1_modified = r"C:\Maxime\ECM\Stages\SSE\Recherche\17032025\beach\f07\f07_A03_beach_run1_modified.csv"
f07_A03_No_beach_run1_modified = r"C:\Maxime\ECM\Stages\SSE\Recherche\17032025\No_beach\f07\f07_A03_run2_modified.csv"


# Getting wave x for each probe
df07_b = pd.read_csv(f07_A03_beach_run1_modified, skiprows=V9tp1e_f07, nrows=V9tp1s_f07-V9tp1e_f07)
P1_b = df07_b.iloc[:, C1].tolist()

df2_b = pd.read_csv(f07_A03_beach_run1_modified, skiprows=V9tp2e_f07, nrows=V9tp2s_f07-V9tp2e_f07)
P2_b = df2_b.iloc[:, C2].tolist()

df3_b = pd.read_csv(f07_A03_beach_run1_modified, skiprows=V9tp3e_f07, nrows=V9tp3s_f07-V9tp3e_f07)
P3_b = df3_b.iloc[:, C3].tolist()

df4_b = pd.read_csv(f07_A03_beach_run1_modified, skiprows=V9tp4e_f07, nrows=V9tp4s_f07-V9tp4e_f07)
P4_b = df4_b.iloc[:, C4].tolist()


df07_nb = pd.read_csv(f07_A03_No_beach_run1_modified, skiprows=V9tp1e_f07, nrows=V9tp1s_f07-V9tp1e_f07)
P1_nb = df07_nb.iloc[:, C1].tolist()

df2_nb = pd.read_csv(f07_A03_No_beach_run1_modified, skiprows=V9tp2e_f07, nrows=V9tp2s_f07-V9tp2e_f07)
P2_nb = df2_nb.iloc[:, C2].tolist()

df3_nb = pd.read_csv(f07_A03_No_beach_run1_modified, skiprows=V9tp3e_f07, nrows=V9tp3s_f07-V9tp3e_f07)
P3_nb = df3_nb.iloc[:, C3].tolist()

df4_nb = pd.read_csv(f07_A03_No_beach_run1_modified, skiprows=V9tp4e_f07, nrows=V9tp4s_f07-V9tp4e_f07)
...
plt.title("Wave 9 at different postions, no beach")
plt.xlabel("x")
plt.ylabel("y")
plt.ylim([-0.02, 0.02])
plt.show()
...
plt.title("Wave 9 at different postions, beach")
plt.xlabel("x")
plt.ylabel("y")
plt.ylim([-0.02, 0.02])
