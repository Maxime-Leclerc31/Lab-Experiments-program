...
V10tp1e_f1 = temps_ligne(X1/v + 10 * 1/f)
V10tp1s_f1 = temps_ligne(X1/v + 11 * 1/f)

V10tp2e_f1 = temps_ligne(X2/v + 10 * 1/f)
V10tp2s_f1 = temps_ligne(X2/v + 11 * 1/f)

V10tp3e_f1 = temps_ligne(X3/v + 10 * 1/f)
V10tp3s_f1 = temps_ligne(X3/v + 11 * 1/f)

V10tp4e_f1 = temps_ligne(X4/v + 10 * 1/f)
V10tp4s_f1 = temps_ligne(X4/v + 11 * 1/f)



# Getting the files names
f1_A03_Beach_run1 = r"C:\Maxime\ECM\Stages\SSE\Recherche\17032025\Beach\f1\f1_A03_beach_run1.csv"
f1_A03_run1 = r"C:\Maxime\ECM\Stages\SSE\Recherche\17032025\No_beach\f1\f1_A03_run2.csv"


## Getting the csv to a good format for reading values
# Reading the csv
df_b = pd.read_csv(f1_A03_Beach_run1, header=None)
df_nb = pd.read_csv(f1_A03_run1, header=None)
...
df_b.to_csv(r"C:\Maxime\ECM\Stages\SSE\Recherche\17032025\Beach\f1\f1_A03_beach_run1_modified.csv", index=False)
df_nb.to_csv(r"C:\Maxime\ECM\Stages\SSE\Recherche\17032025\No_beach\f1\f1_A03_run2_modified.csv", index=False)


# Getting the new file name
f1_A03_Beach_run1_modified = r"C:\Maxime\ECM\Stages\SSE\Recherche\17032025\Beach\f1\f1_A03_beach_run1_modified.csv"
f1_A03_No_beach_run1_modified = r"C:\Maxime\ECM\Stages\SSE\Recherche\17032025\No_beach\f1\f1_A03_run2_modified.csv"


# Getting wave x for each probe
df1_b = pd.read_csv(f1_A03_Beach_run1_modified, skiprows=V10tp1e_f1, nrows=V10tp1s_f1-V10tp1e_f1)
P1_b = df1_b.iloc[:, C1].tolist()

df2_b = pd.read_csv(f1_A03_Beach_run1_modified, skiprows=V10tp2e_f1, nrows=V10tp2s_f1-V10tp2e_f1)
P2_b = df2_b.iloc[:, C2].tolist()

df3_b = pd.read_csv(f1_A03_Beach_run1_modified, skiprows=V10tp3e_f1, nrows=V10tp3s_f1-V10tp3e_f1)
P3_b = df3_b.iloc[:, C3].tolist()

df4_b = pd.read_csv(f1_A03_Beach_run1_modified, skiprows=V10tp4e_f1, nrows=V10tp4s_f1-V10tp4e_f1)
P4_b = df4_b.iloc[:, C4].tolist()


df1_nb = pd.read_csv(f1_A03_No_beach_run1_modified, skiprows=V10tp1e_f1, nrows=V10tp1s_f1-V10tp1e_f1)
P1_nb = df1_nb.iloc[:, C1].tolist()

df2_nb = pd.read_csv(f1_A03_No_beach_run1_modified, skiprows=V10tp2e_f1, nrows=V10tp2s_f1-V10tp2e_f1)
P2_nb = df2_nb.iloc[:, C2].tolist()

df3_nb = pd.read_csv(f1_A03_No_beach_run1_modified, skiprows=V10tp3e_f1, nrows=V10tp3s_f1-V10tp3e_f1)
P3_nb = df3_nb.iloc[:, C3].tolist()

df4_nb = pd.read_csv(f1_A03_No_beach_run1_modified, skiprows=V10tp4e_f1, nrows=V10tp4s_f1-V10tp4e_f1)
...
plt.title("Wave 10 at different postions, no beach")
plt.xlabel("x")
plt.ylabel("y")
plt.ylim([-0.03, 0.03])
plt.show()
...
plt.title("Wave 10 at different postions, beach")
plt.xlabel("x")
plt.ylabel("y")
plt.ylim([-0.03, 0.03])
