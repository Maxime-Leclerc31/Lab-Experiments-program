...
V9tp1e_0 = temps_ligne(X1_0/v + 9 * 1/f)
V9tp1s_0 = temps_ligne(X1_0/v + 10 * 1/f)

V9tp2e_0 = temps_ligne(X2_0/v + 9 * 1/f)
V9tp2s_0 = temps_ligne(X2_0/v + 10 * 1/f)

V9tp3e_0 = temps_ligne(X3_0/v + 9 * 1/f)
V9tp3s_0 = temps_ligne(X3_0/v + 10 * 1/f)

V9tp4e_0 = temps_ligne(X4_0/v + 9 * 1/f)
V9tp4s_0 = temps_ligne(X4_0/v + 10 * 1/f)


V9tp1e_1 = temps_ligne(X1_1/v + 9 * 1/f)
V9tp1s_1 = temps_ligne(X1_1/v + 10 * 1/f)

V9tp2e_1 = temps_ligne(X2_1/v + 9 * 1/f)
V9tp2s_1 = temps_ligne(X2_1/v + 10 * 1/f)

V9tp3e_1 = temps_ligne(X3_1/v + 9 * 1/f)
V9tp3s_1 = temps_ligne(X3_1/v + 10 * 1/f)

V9tp4e_1 = temps_ligne(X4_1/v + 9 * 1/f)
V9tp4s_1 = temps_ligne(X4_1/v + 10 * 1/f)


V9tp1e_2 = temps_ligne(X1_2/v + 9 * 1/f)
V9tp1s_2 = temps_ligne(X1_2/v + 10 * 1/f)

V9tp2e_2 = temps_ligne(X2_2/v + 9 * 1/f)
V9tp2s_2 = temps_ligne(X2_2/v + 10 * 1/f)

V9tp3e_2 = temps_ligne(X3_2/v + 9 * 1/f)
V9tp3s_2 = temps_ligne(X3_2/v + 10 * 1/f)

V9tp4e_2 = temps_ligne(X4_2/v + 9 * 1/f)
V9tp4s_2 = temps_ligne(X4_2/v + 10 * 1/f)
...
# Reading the csv
df_0 = pd.read_csv(f07_A03_x10086_run1, header=None)
df_1 = pd.read_csv(f07_A03_x10186_run1, header=None)
df_2 = pd.read_csv(f07_A03_x10286_run1, header=None)
...
df_0.to_csv(r"C:\Maxime\ECM\Stages\SSE\Recherche\19032025\x10086\f07\f07_A03_x10086_run1_modified.csv", index=False)
df_1.to_csv(r"C:\Maxime\ECM\Stages\SSE\Recherche\19032025\x10186\f07\f07_A03_x10186_run1_modified.csv", index=False)
df_2.to_csv(r"C:\Maxime\ECM\Stages\SSE\Recherche\19032025\x10286\f07\f07_A03_x10286_run1_modified.csv", index=False)


# Getting the new file name
f07_A03_x10086_run1_modified = r"C:\Maxime\ECM\Stages\SSE\Recherche\19032025\x10086\f07\f07_A03_x10086_run1_modified.csv"
f07_A03_x10186_run1_modified = r"C:\Maxime\ECM\Stages\SSE\Recherche\19032025\x10186\f07\f07_A03_x10186_run1_modified.csv"
f07_A03_x10286_run1_modified = r"C:\Maxime\ECM\Stages\SSE\Recherche\19032025\x10286\f07\f07_A03_x10286_run1_modified.csv"


# Getting wave x for each probe
df1_0 = pd.read_csv(f07_A03_x10086_run1_modified, skiprows=V9tp1e_0, nrows=V9tp1s_0-V9tp1e_0)
P1_0 = df1_0.iloc[:, C1].tolist()

df2_0 = pd.read_csv(f07_A03_x10086_run1_modified, skiprows=V9tp2e_0, nrows=V9tp2s_0-V9tp2e_0)
P2_0 = df2_0.iloc[:, C2].tolist()

df3_0 = pd.read_csv(f07_A03_x10086_run1_modified, skiprows=V9tp3e_0, nrows=V9tp3s_0-V9tp3e_0)
P3_0 = df3_0.iloc[:, C3].tolist()

df4_0 = pd.read_csv(f07_A03_x10086_run1_modified, skiprows=V9tp4e_0, nrows=V9tp4s_0-V9tp4e_0)
P4_0 = df4_0.iloc[:, C4].tolist()


df1_1 = pd.read_csv(f07_A03_x10186_run1_modified, skiprows=V9tp1e_1, nrows=V9tp1s_1-V9tp1e_1)
P1_1 = df1_1.iloc[:, C1].tolist()

df2_1 = pd.read_csv(f07_A03_x10186_run1_modified, skiprows=V9tp2e_1, nrows=V9tp2s_1-V9tp2e_1)
P2_1 = df2_1.iloc[:, C2].tolist()

df3_1 = pd.read_csv(f07_A03_x10186_run1_modified, skiprows=V9tp3e_1, nrows=V9tp3s_1-V9tp3e_1)
P3_1 = df3_1.iloc[:, C3].tolist()

df4_1 = pd.read_csv(f07_A03_x10186_run1_modified, skiprows=V9tp4e_1, nrows=V9tp4s_1-V9tp4e_1)
P4_1 = df4_1.iloc[:, C4].tolist()


df1_2 = pd.read_csv(f07_A03_x10286_run1_modified, skiprows=V9tp1e_2, nrows=V9tp1s_2-V9tp1e_2)
P1_2 = df1_2.iloc[:, C1].tolist()

df2_2 = pd.read_csv(f07_A03_x10286_run1_modified, skiprows=V9tp2e_2, nrows=V9tp2s_2-V9tp2e_2)
P2_2 = df2_2.iloc[:, C2].tolist()

df3_2 = pd.read_csv(f07_A03_x10286_run1_modified, skiprows=V9tp3e_2, nrows=V9tp3s_2-V9tp3e_2)
P3_2 = df3_2.iloc[:, C3].tolist()

df4_2 = pd.read_csv(f07_A03_x10286_run1_modified, skiprows=V9tp4e_2, nrows=V9tp4s_2-V9tp4e_2)
...
AlphaP2_0=(np.log(MAP1_0)-np.log(MAP2_0))/X2_0
AlphaP3_0=(np.log(MAP1_0)-np.log(MAP3_0))/X3_0
AlphaP4_0=(np.log(MAP1_0)-np.log(MAP4_0))/X4_0

AlphaP1_1=(np.log(MAP1_0)-np.log(MAP1_1))/X1_1
AlphaP2_1=(np.log(MAP1_0)-np.log(MAP2_1))/X2_1
AlphaP3_1=(np.log(MAP1_0)-np.log(MAP3_1))/X3_1
AlphaP4_1=(np.log(MAP1_0)-np.log(MAP4_1))/X4_1

AlphaP1_2=(np.log(MAP1_0)-np.log(MAP1_2))/X1_2
AlphaP2_2=(np.log(MAP1_0)-np.log(MAP2_2))/X2_2
AlphaP3_2=(np.log(MAP1_0)-np.log(MAP3_2))/X3_2
AlphaP4_2=(np.log(MAP1_0)-np.log(MAP4_2))/X4_2
...
plt.plot(np.linspace(0,30,len(P1_1)),P1_1,"darkslateblue")
plt.plot(T,P1_2,"blueviolet")
plt.plot(np.linspace(0,30,len(P2_0)),P2_0,"mediumorchid")
plt.plot(T,P2_1,"purple")
plt.plot(T,P2_2,"magenta")
plt.plot(np.linspace(0,30,len(P3_0)),P3_0,"hotpink")
plt.plot(T,P3_1,"pink")
plt.plot(T,P3_2,"blanchedalmond")
plt.plot(T,P4_0,"burlywood")
plt.plot(np.linspace(0,30,len(P4_1)),P4_1,"peru")
plt.plot(T,P4_2,"chocolate")
plt.title("Wave 9 at different postions")
plt.xlabel("x")
plt.ylabel("y")
plt.show()
